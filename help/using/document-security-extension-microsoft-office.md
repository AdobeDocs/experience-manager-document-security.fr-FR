...
Document Security Extension for Microsoft® Office améliore LiveCycle Rights Management et Document Security for Adobe Experience Manager Forms. Il protège les fichiers Office et permet aux utilisateurs autorisés d’accéder aux fichiers protégés par une stratégie conformément aux paramètres de confidentialité définis.
...
Après l’application d’une stratégie à un fichier, les paramètres de confidentialité de la stratégie peuvent être modifiés à tout moment. Vous pouvez ajouter ou supprimer des utilisateurs autorisés ou modifier les privilèges des utilisateurs une fois le fichier reçu. La stratégie appliquée au fichier peut être modifiée. De plus, l’accès au fichier peut être révoqué afin que toute personne disposant d’une copie du fichier ne puisse plus l’ouvrir.
...
Pour qu’un utilisateur puisse ouvrir et utiliser des fichiers Word, Excel et PowerPoint protégés par une stratégie, la stratégie doit inclure l’utilisateur comme destinataire. Il doit également autoriser l’accès anonyme. L’utilisateur doit également avoir installé Document Security Extension for Microsoft® Office. Pour fournir un fichier protégé par une stratégie à une personne qui ne dispose pas de Document Security Extension for Microsoft® Office, vous pouvez lui fournir une copie du logiciel. Vous pouvez également leur indiquer comment le télécharger à partir de votre site web. Si vous ne disposez pas du programme d’installation, vous pouvez le télécharger à partir de la [page des téléchargements](https://experienceleague.adobe.com/en/docs/experience-manager-document-security/using/download-installer).
...
* jusqu’à ce que l’administrateur ou la personne ayant appliqué la politique révoque l’accès au fichier ou modifie la politique.
  ...
  Si la stratégie autorise l’accès hors connexion, les utilisateurs peuvent ouvrir des fichiers protégés par une stratégie sans connexion Internet ou réseau pendant la période d’ouverture hors connexion spécifiée. Lorsque la période d’ouverture hors connexion se termine, l’utilisateur doit se connecter et se synchroniser avec Document Security, ce qui démarre une nouvelle période d’ouverture.

  Si la stratégie autorise l’accès hors connexion, les utilisateurs peuvent ouvrir des fichiers protégés par une stratégie sans connexion Internet ou réseau pendant la période d’ouverture hors connexion spécifiée. Les événements tels que les tentatives d’ouverture du nouveau fichier sont également contrôlés et enregistrés comme pour le fichier original.
...
Après avoir accepté une offre, le fabricant met à jour la politique afin d’accorder aux enchérisseurs les autorisations nécessaires pour imprimer, copier et enregistrer les modifications en local. Le fabricant retire également les offres qui n’ont pas abouti et révoque leur autorisation d’ouvrir les fichiers.
