...
Les administrateurs et les utilisateurs de Document Security créent des politiques. Les administrateurs créent des politiques organisationnelles accessibles à tous les utilisateurs autorisés. Les personnes en charge de l’administration ou celles chargées de coordonner les politiques peuvent également créer des groupes de politiques appelés *ensembles de politiques* mis à la disposition d’un sous-ensemble d’utilisateurs et d’utilisatrices. Les utilisateurs peuvent créer leurs propres politiques, qu’eux seuls peuvent utiliser. Les administrateurs et les administratrices, les coordinateurs et les coordinatrices d’ensembles de politiques et les utilisateurs et les utilisatrices créent des politiques à l’aide des pages web de Document Security.
...
<table >
 <tbody>
  ...
  <tr>
   ...
   <td><p><a href="https://experienceleague.adobe.com/?support-solution=General&amp;lang=fr&amp;support-tab=home#support">Support technique d’Experience Cloud</a></p> </td>
  </tr>
 </tbody>
</table>
