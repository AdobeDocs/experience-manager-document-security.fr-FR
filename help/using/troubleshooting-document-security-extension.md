...
Si vous rencontrez des problèmes lors de l’installation et de la configuration d’AEM Document Security Extension for Microsoft Office, veillez à suivre attentivement les instructions de la section - Avant l’installation - de l’article [installation](installing-configuring-aemdsext.md) .
...
Pour plus d’informations sur LoadBehavior, consultez l’article [Entrées du registre pour les modules complémentaires VSTO](https://learn.microsoft.com/en-us/visualstudio/vsto/registry-entries-for-vsto-add-ins?view=vs-2022&amp;redirectedfrom=MSDN#LoadBehavior).
...
Pour garantir le démarrage correct des applications Office avec Document Security Extension installé et McAfee VirusScan avec activation de l’option d’analyse lors de l’accès, désactivez la protection contre le débordement de la mémoire tampon dans la console McAfee VirusScan.
